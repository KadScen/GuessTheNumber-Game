...
import NumberContainer from "../components/game/NumberContainer.component";
...
import GuessLogItem from "../components/game/GuessLogItem.component";
...
function GameScreen({ userNumber, onGameOver }) {
  ...
  return (
    <View style={styles.screen}>
      ...
      {content}
      <View style={[styles.listContainer, { padding: listSpacing }]}>
